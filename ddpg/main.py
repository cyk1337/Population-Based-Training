...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_timesteps", default=1050000, type=float)  # Max time steps to run environment for
    ...
    file_name = "%s_%s_seed=%s" % (args.policy_name, args.env_name, str(args.seed))
    print("---------------------------------------")
