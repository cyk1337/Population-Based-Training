...
from utils import copy_weights_from_models, adjust_learning_rate
...
class DDPG(object):
    def __init__(self, state_dim, action_dim, max_action, ACTOR_LR=1e-3, CRITIC_LR=1e-3):
    ...
    def copy_hyperparams(self, new_h):
        # update lr
        adjust_learning_rate(self.actor_optimizer, new_h.ACTOR_LEARNING_RATE)
        adjust_learning_rate(self.critic_optimizer, new_h.CRITIC_LEARNING_RATE)
        # update batch size
        self.BATCH_SIZE = new_h.BATCH_SIZE
